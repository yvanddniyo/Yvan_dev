...
export const DATA = {
  ...
  avatarUrl: "/Yvan_placeholder.jpeg",
  skills: [
    "React",
    "Next.js",
    "Typescript",
  ...
  contact: {
    email: "nyvan80076@gmail.com",
    tel: "+250780076941",
    social: {
      GitHub: {
        name: "GitHub",
        url: "https://github.com/yvanddniyo",
        icon: Icons.github,
      ...
      LinkedIn: {
        name: "LinkedIn",
        url: "https://www.linkedin.com/in/niyonshima-yvan-04247327a/",
        icon: Icons.linkedin,
  ...
  work: [
    {
      company: "BAG",
      href: "https://app.bag.rw",
      badges: [],
      location: "Hybrid",
      title: "Software Engineer ",
      logoUrl: "/bag-logo.ico",
      start: "Dec 2023",
      end: "Present",
      description:
    ...
    {
      company: "Andala",
      href: "https://andala.com",
      badges: [],
      location: "Hybrid",
      title: "Software Engineer",
      logoUrl: "/andela-logo.png",
      start: "Feb 2024",
      end: "Aug 2024",
      description:
  ...
  education: [
    {
      school: "RP Huye",
      href: "https://www.iprchuye.rp.ac.rw/",
      degree: "Advanced Diploma in Electrical and Electronic Engineering",
      logoUrl: "/Rp-huye.jpg",
      start: "2023",
      end: "2020",
    },
